...
Usage:
    python plot_detailed_inputnoise_histograms_per_file_UCSC.py -i 'UCSC/HX/SN20USBHX2002099/SN20USBHX2002099_*.json'
    python plot_detailed_inputnoise_histograms_per_file_UCSC.py -i 'UCSC/HX/SN*/*.json'
    python plot_detailed_inputnoise_histograms_per_file_UCSC.py --serial_number 20USBHX2002592
"""
