#!/usr/bin/env python3
"""
Script: plot_combined_inputnoise_noskip_LBNL_one_channel_subcategories.py

Usage:
    python plot_combined_inputnoise_noskip_LBNL_one_channel_subcategories.py -i "LBNL/HX/SN*/*.json" -o "LBNL/HX2"

    python plot_combined_inputnoise_noskip_LBNL_one_channel_subcategories.py \
