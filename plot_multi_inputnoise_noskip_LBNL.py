...
Usage:
python plot_multi_inputnoise_noskip_LBNL.py -i 'LBNL/HX/SN20USBHX2003825/SN20USBHX2003825_*.json'
python plot_multi_inputnoise_noskip_LBNL.py -i 'LBNL/HX/SN*/*.json'

Output example:
LBNL/HX3/SN20USBHX2003825/inputnoise_noskip/SN20USBHX2003825-away.png
LBNL/HX3/SN20USBHX2003825/inputnoise_noskip/SN20USBHX2003825-under.png
'''
...
def mk_inoise_plot(module_name, input_files, stream="under", output_base_dir="LBNL/HX3"):
    ...
    # Saves into:
    # LBNL/HX3/SERIAL/inputnoise_noskip/
...
def main():
    ...
    parser.add_argument(
        "-i",
        "--input",
        help="Glob pattern, e.g. 'LBNL/HX/SN20USBHX2003825/SN20USBHX2003825_*.json' or 'LBNL/HX/SN*/*.json'",
    )
    ...
    if args.input:
        ...
        input_files = sorted(glob(f"LBNL/HX/SN{serial_number}/SN{serial_number}_*.json"))
    ...
    # Do not infer LBNL/HX from the input path.
    # Always use args.output, which defaults to LBNL/HX3.
