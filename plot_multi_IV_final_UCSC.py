...
def build_module_file_map(input_files):
    ...
    This is much faster than scanning all JSON files again for every module.
    """
...
def main():
    parser = argparse.ArgumentParser(
        description="Fast UCSC IV plotter plus Category A / D(i) summary generator."
    )
    ...
    parser.add_argument(
        ...
        "--input",
        required=True,
        help='Input glob, for example "UCSC/ML/*/*.json"',
    )
    ...
    print("\n" + "=" * 80)
    print("FAST UCSC IV PLOTTING + CATEGORY SUMMARY")
    print("=" * 80)
    ...
    iv_category_summary_file = output_base_dir / "iv_category_summary_ucsc.txt"
