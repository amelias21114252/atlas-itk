...
def main():
    parser = argparse.ArgumentParser(
        description="Fast BNL IV plotter plus Category A / D(i) summary generator."
    )
    ...
    parser.add_argument(
        ...
        "--input",
        required=True,
        help='Input glob, for example "BNL/ML/*/*.json"',
    )
    ...
    print("\n" + "=" * 80)
    print("FAST BNL IV PLOTTING + CATEGORY SUMMARY")
    print("=" * 80)
    ...
    iv_category_summary_file = output_base_dir / "iv_category_summary_bnl.txt"
