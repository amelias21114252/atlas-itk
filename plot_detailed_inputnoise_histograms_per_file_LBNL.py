#!/usr/bin/env python3
"""
Script: plot_detailed_inputnoise_histograms_per_file_LBNL.py
...
Description:
    ...
    - Saves plots inside LBNL/HX3/SN.../detailedhistograms/
...
Usage:
    python plot_detailed_inputnoise_histograms_per_file_LBNL.py -i 'LBNL/HX/SN20USBHX2002099/SN20USBHX2002099_*.json'
    python plot_detailed_inputnoise_histograms_per_file_LBNL.py -i 'LBNL/HX/SN*/*.json'
    python plot_detailed_inputnoise_histograms_per_file_LBNL.py --serial_number 20USBHX2002592
"""
...
def main():
    ...
    parser.add_argument(
        "-i",
        "--input",
        help="Glob pattern, e.g. 'LBNL/HX/SN20USBHX2002099/SN20USBHX2002099_*.json' or 'LBNL/HX/SN*/*.json'",
    )
    ...
    parser.add_argument(
        ...
        "--output",
        default=None,
        help="Output base directory. Default is inferred from input path, e.g. LBNL/HX3",
    )
    ...
    output_base_dir = args.output or get_base_output_dir(input_files, "LBNL/HX3")
