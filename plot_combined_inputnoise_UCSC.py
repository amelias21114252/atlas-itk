#!/usr/bin/env python3
"""
Script: plot_combined_inputnoise_UCSC.py

Usage:
python plot_combined_inputnoise_UCSC.py -i 'UCSC/HX/SN20USBHX2002099/SN20USBHX2002099_*.json'
python plot_combined_inputnoise_UCSC.py -i 'UCSC/HX/SN*/*.json'
python plot_combined_inputnoise_UCSC.py --serial_number 20USBHX2002657
"""
...
def get_base_output_dir(input_files, fallback_output="UCSC/HX3"):
    if not input_files:
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            "Glob pattern, e.g. "
            "'UCSC/HX/SN20USBHX2002099/SN20USBHX2002099_*.json' "
            "or 'UCSC/HX/SN*/*.json'"
        ),
    )
