...
Usage:
python plot_combined_inputnoise_BNL.py -i 'BNL/HX/SN20USBHX2002099/SN20USBHX2002099_*.json'
python plot_combined_inputnoise_BNL.py -i 'BNL/HX/SN*/*.json'
python plot_combined_inputnoise_BNL.py --serial_number 20USBHX2002657
"""
